/*
CODE BY: CraigTP on http://stackoverflow.com
Check: http://stackoverflow.com/questions/10168240/encrypting-decrypting-a-string-in-c-sharp
*/
...
namespace Blitzkrieg.Controllers
{
    public class CryptController
    {
        ...
        public string Encrypt(string plainText, SecureString passPhrase)
        {
            ...
            using (var password = new Rfc2898DeriveBytes(ToUnsecureString(passPhrase), saltStringBytes, DerivationIterations))
            {
        ...
        private string ToUnsecureString(SecureString secureStr)
        {
            if (secureStr == null)
